function start() { //inicio função start
   ...
   //principais variáveis
    ...
    var fimdejogo = false
    var velocidade = 5;
    var posicaoY = parseInt(Math.random()* 334); //posição aleatoria inimigo1
    var TECLA = {
        W: 87,
        S: 83,
        D: 68,
        A:65,
        space: 32
    } //teclas utilizaveis do player

    //função pressionar botões
    ...
    jogo.timer = setInterval(loop, 30); //loop do fundo tela
...
const button = document.getElementById('botaoInicio');
